    ...
    return (
        <header className={baseHeaderClassName+headerClassName}>
            <div className="h-full flex items-center">
                <svg className="w-[20px] fill-[#000c] mr-5 hidden max-md:block" viewBox="0 0 24 24" stroke="currentColor" focusable="false">
                ...
                <div className={"font-bold transition-all duration-300 ease-in-out " + logoClassName}>Work Insights</div>
            </div>
            <div className="h-full flex items-center">
                ...
                <svg className="w-[20px] fill-[#000c]" viewBox="0 0 24 24" focusable="false">
